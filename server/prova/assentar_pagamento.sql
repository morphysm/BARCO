...
insert into public.codigos (codigo, user_id) values
  ('BAR-7X2K', '11111111-1111-1111-1111-111111111111');
...
insert into public.codigos (codigo, user_id) values
  ('BAR-CEST', '11111111-1111-1111-1111-111111111111');
insert into public.codigo_itens (codigo, ato_slug, quantidade) values
...
insert into public.codigos (codigo, user_id) values
  ('BAR-POUC', '11111111-1111-1111-1111-111111111111');
insert into public.codigo_itens (codigo, ato_slug, quantidade) values
